...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Selanjutnya",sPrevious:"Sebelumnya"},sEmptyTable:"Tidak ada data pada tabel",sInfo:"Menampilkan _START_ to _END_ of _TOTAL_ entri",sInfoEmpty:"Menampilkan 0 to 0 of 0 entri",sInfoFiltered:"(filtered from _MAX_ total entri)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Menampilkan _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
