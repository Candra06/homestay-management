                                ...
                                <div class="card-body">
                                    <div class="rowpd-l-20 pd-r-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 container-value-discount">
                                                <div class="form-group">
                ...
                if (roomData.additional.length > 0) {
                    for (const addIdx in roomData.additional) {
                        ...
                        <tr>
                            ...
                            <td>${formatTanggal(roomData.check_in)}</td>
                            <td>${formatTanggal(roomData.check_out)}</td>
                            <td class="tx-center">${addItem.total_night}</td>
                            <td class="tx-right">${rupiah(addItem.price * addItem.total_night)}</td>
                        </tr>
                    `;
                        totalPrice += addItem.price * addItem.total_night;
                    }
                }
