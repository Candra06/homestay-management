    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                ...
                <a href="index.html"><img src="../../backdoor-sukalelang/assets/img/brand/logo-apps.png" class="logo-2"
                        alt="logo"></a>
            ...
            <ul class="nav nav-item  navbar-nav-right ms-auto">
                ...
                <li class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex " href=""><img alt=""
                            ...
                            onerror="this.onerror=null;this.src='{{ asset('avatar/default.png') }}';"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ asset('avatar/default.png') }}"
                                        onerror="this.onerror=null;this.src='{{ asset('avatar/default.png') }}';"
                                        class=""></div>
                                <div class="ms-3 my-auto">
                                    <h6>{{ Auth::user()->username }}</h6><span>Front Office</span>
                                </div>
                            </div>
                        </div>
